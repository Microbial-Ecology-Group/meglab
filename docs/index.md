...
The MEGARes V4.0 contains 11,506 antimicrobial resistance gene accessions (a 32% increase from MEGARes 3.0) organized within an acyclic hierarchical ontology comprising 1,609 gene groups, 275 mechanisms and 63 resistance classes. Database updates include semi-automated sequence retrieval and annotation, explicit sequence-cluster identifiers, cross-database accession mapping, and expanded annotation of resistance determinants requiring confirmation of resistance-conferring variants. MEGARes was specifically designed for use in high-throughput metagenomic classification. The acyclical annotation graph of MEGARes allows for accurate, count-based, hierarchical statistical analysis of resistance at the population level, much like microbiome analysis, and is also designed to be used as a training database for the creation of statistical classifiers.

### [AMR++ Pipeline](./amrplusplus/index.md)
AMR++ is a bioinformatic pipeline meant to aid in the analysis of raw sequencing reads to  characterize the profile of antimicrobial resistance genes, or resistome. AMR++ was developed to work in conjuction with the the MEGARes database and its accompanying acyclical annotation structure that is optimized for use with high throughput sequencing and metagenomic analysis.  AMR++ V4.0 adds workflows for single-end and merged paired-end reads, read-level deduplication, fragment-level counting, user-configurable gene and query coverage filtering, and tools for evaluating the effects of filtering thresholds on individual datasets. A new single-nucleotide variant module extends resistome characterization beyond gene abundance by identifying nucleotide variation within antimicrobial resistance genes. Together, these updates provide more comprehensive and transparent database resources while allowing analytical choices to be better matched to sequencing design, dataset characteristics and research objectives.
