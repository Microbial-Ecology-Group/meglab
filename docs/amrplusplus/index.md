...
MEGARes 4.0 contains sequence data for approximately 11,500 hand-curated antimicrobial resistance genes. AMR++ 4.0 adds workflows for single-end and merged paired-end reads, read-level deduplication, fragment-level counting, user-configurable gene and query coverage filtering, and tools for evaluating the effects of filtering thresholds on individual datasets. A new single-nucleotide variant module extends resistome characterization beyond gene abundance by identifying nucleotide variation within antimicrobial resistance genes. Together, these updates provide more comprehensive and transparent database resources while allowing analytical choices to be better matched to sequencing design, dataset characteristics and research objectives. 
...
- **New Features**
  - AMR++ 4.0 now includes workflows for single-end and merged paired-end reads, read-level deduplication, fragment-level counting, user-configurable gene and query coverage filtering, and tools for evaluating the effects of filtering thresholds on individual datasets.
  - A new single-nucleotide variant module extends resistome characterization beyond gene abundance by identifying nucleotide variation within antimicrobial resistance genes.
  - Together, these updates provide more comprehensive and transparent database resources while allowing analytical choices to be better matched to sequencing design, dataset characteristics and research objectives.
